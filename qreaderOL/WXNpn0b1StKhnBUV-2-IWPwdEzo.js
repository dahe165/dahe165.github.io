;if(CloudflareApps.matchPage(CloudflareApps.installs['yspkGx53IsEa'].URLPatterns)){(function(){"use strict"
if(!window.addEventListener)return
var options=CloudflareApps.installs['yspkGx53IsEa'].options
var element
...
return max}
function inIframe(){try{if("yspkGx53IsEa"==='preview'){return window.top!==window.parent.parent}
...
let isConsent=!((!inIframe())&&("yspkGx53IsEa"==='preview'||((localStorageValid===false)||(localStorageValid===undefined))));if(!((options.callbackFunction=="")||(options.callbackFunction==null))){window.onload=function(){let fn=window[options.callbackFunction]
...
elementButton.onclick=function(){if("yspkGx53IsEa"!='preview'){let fn=window[options.callbackFunction]
...
window.CloudflareApps.installs['yspkGx53IsEa'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
