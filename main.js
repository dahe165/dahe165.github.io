...
const soundManager = {
    ...
    sources: {
        lift: {
            ...
            fileNames: [
                'zMHLimJ5lCDq35R4rPuu7TjRKBT1Hv4z',
                '3zoyHhwFd2WVS6odaQAb3jeixiGMLcrU',
                'gzgouiFjJKo9EgN5nK6rnbqADVtJpddd'
            ]
        },
        burst: {
            volume: 1,
            ...
            playbackRateMax: 0.9,
            fileNames: [
                'GaIV1SdWerrMDea1X1eNM4bOhcPIgsdg',
                '2RHC1mRpk0Vjiht4Dgfub3YhBTY9GHc6'
            ]
        },
        burstSmall: {
            volume: 0.25,
            ...
            playbackRateMax: 1,
            fileNames: [
                'by31t1vqcFSKDdvIQwtiCTMrYUweLktQ',
                'bqZn5uPLLBIi7xizuajMTTY3qfERRFeK'
            ]
        },
        crackle: {
            volume: 0.2,
            playbackRateMin: 1,
            playbackRateMax: 1,
            fileNames: ['nmkbMZjULFCngfV0f5oOkSIHm2hDRiho']
        },
        crackleSmall: {
            volume: 0.3,
            playbackRateMin: 1,
            playbackRateMax: 1,
            fileNames: ['Lk4DwQJKgsLjbVR0LOmi3p8a9H7Ed8vH']
        }
    },
