...
let debug=window.location.search.includes("ezbc_debug=true");if(typeof cacheStore!=='undefined'&&cacheStore){epbjs.ezBidCache=new PrebidBidCache(cacheStore,testFeatures,debug);}});}catch(err){var hREED=function(er){return function(){reportEzError(er,"QRCodeScannerPageloot/tuscon.js")}};typeof reportEzError==="function"?hREED(err):window.addEventListener('reportEzErrorDefined',hREED(err),{once:true});console.error(err);}